    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rv_topMainCate.setUp(mainCatItemData!!, R.layout.item_top_cate, { it1 ->
            ...
            this.ll_mainCat.setOnClickListener {
                ...
                utilities.enterNextReplaceFragment(R.id.ll_homeFragment, SubCatFrag.newInstance( it1.subCat, ""), (ctx as MainActivity).supportFragmentManager)
            }
        }, { view1: View, i: Int -> })
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful && (response.body()!!.status.equals("200"))) {
                    if(strAction.equals("add"))
                        dataItem!!.favorite="yes"
                    if(strAction.equals("remove"))
                        dataItem!!.favorite="no"
